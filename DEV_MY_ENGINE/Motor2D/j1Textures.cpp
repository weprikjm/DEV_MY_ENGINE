...
bool j1Textures::Awake(pugi::xml_node texturesData)
{
...
SDL_Surface* j1Textures::Load_image(SDL_RWops* img)
{
	SDL_Surface* image;
	image = IMG_Load_RW(img, 1);
	if (!image)
	{
		LOG("ERROR loading image from SDL_RWops");
	}
	return image;
}
